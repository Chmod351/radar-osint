...
log_info "[INTEL] Enriqueciendo datos técnicos para $TARGET..."

if [[ ! -f "$INPUT_JSON" ]]; then
    log_error "[-] Error: No existe el reporte de la Fase 1 ($INPUT_JSON)"
    exit 1
fi
...
log_success "[DONE] Intel consolidado como Objeto en: $OUTPUT_FILE"
